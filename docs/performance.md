...
the zbuffer is implemented on GE5 and GE10, and all shading (flat + gouraud) is being done on the 2903 FBCs, this means that one of those is a 5-cycle thing, OUCH!
